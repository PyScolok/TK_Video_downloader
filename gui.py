...
from settings import MAIN_FONT, VIDEO_TITLE_FONT
...
class Gui:
    def __init__(self, window):
        ...
        self.url_input_field = tk.Entry(self.start_frame, font=MAIN_FONT)
        self.accept_button = tk.Button(self.start_frame, text='Accept', width=15, height=2, font=MAIN_FONT,
                                       command=self.accept_button_handler)
        ...
        self.video_title_label = tk.Label(self.left_work_frame, font=VIDEO_TITLE_FONT, wraplength=450, text='')
        ...
        self.download_button = tk.Button(self.right_work_frame, text='Download', height=1, font=MAIN_FONT,
                                         command=self.download_video)
        self.back_button = tk.Button(self.right_work_frame, text='Back', height=1, font=MAIN_FONT, command=self.back)
    ...
    def place_right_work_content(self):
        ...
        self.download_button.place(x=100, y=380, width=95)
        self.back_button.place(x=0, y=380, width=95)
